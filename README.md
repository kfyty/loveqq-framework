...
dependencies {
    implementation 'com.kfyty:loveqq-framework:1.1.2@pom'
    implementation 'com.kfyty:loveqq-boot:1.1.2'
    implementation 'com.kfyty:loveqq-boot-starter-logback:1.1.2'
