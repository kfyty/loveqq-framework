...
dependencies {
    implementation 'com.kfyty:loveqq-framework:1.0.9@pom'
    implementation 'com.kfyty:loveqq-boot:1.0.9'
    implementation 'com.kfyty:loveqq-boot-starter-logback:1.0.9'
