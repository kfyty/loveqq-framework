...
import static com.kfyty.loveqq.framework.data.korm.session.Configuration.EXECUTE_LABEL;
import static com.kfyty.loveqq.framework.data.korm.session.Configuration.MAPPER_NAMESPACE;
import static com.kfyty.loveqq.framework.data.korm.session.Configuration.MAPPER_STATEMENT_ID;
import static com.kfyty.loveqq.framework.data.korm.session.Configuration.SELECT_LABEL;
