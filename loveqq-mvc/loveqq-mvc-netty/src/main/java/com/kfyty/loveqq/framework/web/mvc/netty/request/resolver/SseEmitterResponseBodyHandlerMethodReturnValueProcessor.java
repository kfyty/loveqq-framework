...
public class SseEmitterResponseBodyHandlerMethodReturnValueProcessor extends AbstractResponseBodyHandlerMethodReturnValueProcessor implements ReactorHandlerMethodReturnValueProcessor {

    @Override
    public boolean supportsReturnType(Object returnValue, MethodParameter returnType) {
        return super.supportsReturnType(returnValue, returnType) && returnValue instanceof SseEmitter;
    }
    ...
    public Object transformReturnValue(Object returnValue, MethodParameter returnType, ModelViewContainer container) throws Exception {
        ...
        return FlowAdapters.toPublisher(emitter.toPublisher());
    }
}
