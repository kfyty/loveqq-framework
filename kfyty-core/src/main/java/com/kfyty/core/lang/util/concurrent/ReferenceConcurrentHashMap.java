 ...
 *
 * <p>
 * Like {@link Hashtable} but unlike {@link java.util.HashMap}, this class does
 ...
 */
public class ReferenceConcurrentHashMap<K, V> extends AbstractMap<K, V> implements java.util.concurrent.ConcurrentMap<K, V>, Serializable {
     ...
     */
    public ReferenceConcurrentHashMap(int initialCapacity, ReferenceType keyType, ReferenceType valueType) {
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            ReferenceConcurrentHashMap.this.remove(currentKey);
            lastReturned = null;
        }
    }
    ...
    final class WriteThroughEntry extends SimpleEntry<K, V> {
        ...
        public V setValue(V value) {
            ...
            ReferenceConcurrentHashMap.this.put(getKey(), value);
            return v;
        }
    }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        @Override
        public boolean isEmpty() {
            return ReferenceConcurrentHashMap.this.isEmpty();
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            if (!(o instanceof Map.Entry))
                return false;
            Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
            V v = ReferenceConcurrentHashMap.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Map.Entry))
                return false;
            Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
            return ReferenceConcurrentHashMap.this.remove(e.getKey(), e.getValue());
        }
