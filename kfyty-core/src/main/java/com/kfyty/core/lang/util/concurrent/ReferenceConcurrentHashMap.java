 ...
 * @since 3.2
 */
public class ReferenceConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    protected static final ReferenceType DEFAULT_REFERENCE_TYPE = ReferenceType.SOFT;

    protected static final int MAXIMUM_CONCURRENCY_LEVEL = 1 << 16;

    protected static final int MAXIMUM_SEGMENT_SIZE = 1 << 30;
     ...
     *                         write to the map
     */
    public ReferenceConcurrentHashMap(int initialCapacity, int concurrencyLevel) {
     ...
     */
    public ReferenceConcurrentHashMap(int initialCapacity, ReferenceType referenceType) {
    ...
    public ReferenceConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, ReferenceType referenceType) {
    ...
    /**
     * Allows a task access to {@link ReferenceConcurrentHashMap.Segment} entries.
     */
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                ...
                Reference<K, V> ref = ReferenceConcurrentHashMap.this.getReference(entry.getKey(), Restructure.NEVER);
        ...
        public boolean remove(Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                Map.Entry<?, ?> entry = (Map.Entry<?, ?>) o;
                return ReferenceConcurrentHashMap.this.remove(entry.getKey(), entry.getValue());
            }
            return false;
        }
    ...
    private class EntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        private void moveToNextSegment() {
            ...
            if (this.segmentIndex < ReferenceConcurrentHashMap.this.segments.length) {
                this.references = ReferenceConcurrentHashMap.this.segments[this.segmentIndex].references;
                this.segmentIndex++;
            }
        }
        ...
        public void remove() {
            ...
            ReferenceConcurrentHashMap.this.remove(this.last.getKey());
            this.last = null;
        }
    }
    ...
    protected class ReferenceManager {
        ...
        public Reference<K, V> createReference(Entry<K, V> entry, int hash, Reference<K, V> next) {
            if (ReferenceConcurrentHashMap.this.referenceType == ReferenceType.WEAK) {
