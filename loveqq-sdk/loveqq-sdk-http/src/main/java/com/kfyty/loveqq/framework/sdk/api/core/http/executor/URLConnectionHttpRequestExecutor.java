package com.kfyty.loveqq.framework.sdk.api.core.http.executor;
...
public class URLConnectionHttpRequestExecutor implements HttpRequestExecutor {
    ...
    @Override
    public com.kfyty.loveqq.framework.sdk.api.core.http.HttpResponse exchange(HttpRequest<?> api, boolean validStatusCode) {
    ...
    public static class URLConnectionHttpResponse implements com.kfyty.loveqq.framework.sdk.api.core.http.HttpResponse {
