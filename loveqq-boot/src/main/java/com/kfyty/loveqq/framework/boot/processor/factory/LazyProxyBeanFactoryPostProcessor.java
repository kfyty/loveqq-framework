...
import static com.kfyty.loveqq.framework.core.utils.BeanUtil.LAZY_PROXY_SOURCE_PREFIX;
...
public class LazyProxyBeanFactoryPostProcessor extends HardCodeBeanFactoryPostProcessor implements BeanFactoryPostProcessor {
    ...
    public void postProcessBeanFactory(BeanFactory beanFactory) {
        ...
        for (Map.Entry<String, BeanDefinition> beanDefinitionEntry : beanDefinitionMap.entrySet()) {
            ...
            if (!beanDefinition.isLazyInit() || !beanDefinition.isLazyProxy() || !beanDefinition.isAutowireCandidate()) {
                continue;
            }
            ...
            beanFactory.registerBeanDefinition(genericBeanDefinition(LazyProxyFactoryBean.class)
                    .setBeanName(beanDefinition.getBeanName())
                    .setScope(beanDefinition.getScope())
                    .setScopeProxy(beanDefinition.isScopeProxy())
