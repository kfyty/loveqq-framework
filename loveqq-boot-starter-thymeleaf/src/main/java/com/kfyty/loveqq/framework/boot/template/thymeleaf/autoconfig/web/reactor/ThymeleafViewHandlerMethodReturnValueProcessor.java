...
public class ThymeleafViewHandlerMethodReturnValueProcessor implements BeanFactoryAware, ReactiveHandlerMethodReturnValueProcessor {
    ...
    protected AbstractContext buildWebContext(ModelViewContainer container) {
        if (this.webApplication instanceof ReactiveWebApplication) {
            ReactiveWebExchange webExchange = ((ReactiveWebApplication) this.webApplication).buildExchange(container.getRequest(), container.getResponse());
